package by.paul.application.two.repository.impl;

import by.paul.application.two.entity.Book;
import by.paul.application.two.repository.Storage;
import by.paul.application.two.util.WriterUtil;
import by.paul.application.two.util.parser.impl.BookParser;

import java.util.List;

import static by.paul.application.two.configuration.ApplicationConstants.RESOURCES_PATH;
